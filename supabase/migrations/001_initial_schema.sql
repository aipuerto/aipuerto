...
create table if not exists public.services (
  ...
  category        text not null default 'automation' check (category in ('automation','enterprise')),
...
insert into public.services (slug, name, name_en, description, description_en, price, currency, category)
values
  (
    'kartvizit-ajan',
    'Kartvizit Okuyucu',
  ...
  (
    ...
    'ERP Sistemi',
    'ERP System',
    'Airtable tabanlı tam kapsamlı ERP çözümü. Stok, satın alma, satış, üretim ve finans modülleri.',
    'Full-scale Airtable-based ERP solution. Inventory, purchasing, sales, production and finance modules.',
    3500.00, 'USD', 'enterprise'
  ),
  (
    'crm',
    'CRM Sistemi',
    'CRM System',
    'Airtable tabanlı müşteri ilişkileri yönetimi. Lead takibi, satış pipeline, teklif ve sözleşme yönetimi.',
    'Airtable-based customer relationship management. Lead tracking, sales pipeline, proposal and contract management.',
    2500.00, 'USD', 'enterprise'
  ),
  (
    'pazarlama',
    'Pazarlama Otomasyonu',
    'Marketing Automation',
    'AI ile sosyal medya, e-posta kampanyaları ve içerik üretimini otomatikleştirin.',
    'Automate social media, email campaigns and content creation with AI.',
    2000.00, 'EUR', 'enterprise'
  )
